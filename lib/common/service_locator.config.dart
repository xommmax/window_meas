...
import 'package:window_meas/features/auth/bloc/auth_cubit.dart' as _i3;
...
import 'package:window_meas/features/templates/data/ds/template_remote_ds.dart'
    as _i6;
import 'package:window_meas/features/templates/data/template_repo.dart' as _i14;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.singleton<_i9.SettingsLocalDataSource>(
        () => _i9.SettingsIsarLocalDataSource(gh<_i5.Isar>()));
    gh.singleton<_i10.MeasurementLocalDataSource>(
        () => _i10.MeasurementIsarLocalDataSource(gh<_i5.Isar>()));
    gh.singleton<_i11.TemplateLocalDataSource>(
        () => _i11.TemplateIsarLocalDataSource(gh<_i5.Isar>()));
    ...
    gh.singleton<_i14.TemplateRepository>(() => _i14.TemplateRepository(
          gh<_i11.TemplateLocalDataSource>(),
          gh<_i6.TemplateRemoteDataSource>(),
        ));
    gh.factory<_i15.MeasurementDetailsCubit>(() => _i15.MeasurementDetailsCubit(
          gh<_i12.MeasurementRepository>(),
          gh<_i13.SettingsRepository>(),
        ));
    gh.factory<_i16.TemplateListCubit>(
        () => _i16.TemplateListCubit(gh<_i14.TemplateRepository>()));
    ...
    gh.factory<_i19.EditorCubit>(
        () => _i19.EditorCubit(gh<_i14.TemplateRepository>()));
    return this;
  }
}
