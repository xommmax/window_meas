...
/// @nodoc
mixin _$EditorState {
  DrawingState get drawingState => throw _privateConstructorUsedError;
...
abstract class $EditorStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({DrawingState drawingState, EditorMode mode});

  $DrawingStateCopyWith<$Res> get drawingState;
}
...
class _$EditorStateCopyWithImpl<$Res, $Val extends EditorState>
  ...
  @override
  $Res call({
    Object? drawingState = null,
    Object? mode = null,
  }) {
    return _then(_value.copyWith(
      drawingState: null == drawingState
          ? _value.drawingState
          : drawingState // ignore: cast_nullable_to_non_nullable
              as DrawingState,
      mode: null == mode
          ? _value.mode
  ...
  @pragma('vm:prefer-inline')
  $DrawingStateCopyWith<$Res> get drawingState {
    return $DrawingStateCopyWith<$Res>(_value.drawingState, (value) {
      return _then(_value.copyWith(drawingState: value) as $Val);
    });
  }
}
...
class _$EditorStateImpl implements _EditorState {
  const _$EditorStateImpl(
      {this.drawingState = const DrawingState(), this.mode = EditorMode.draw});
  ...
  @override
  String toString() {
    return 'EditorState(drawingState: $drawingState, mode: $mode)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.drawingState, drawingState) ||
                other.drawingState == drawingState) &&
            (identical(other.mode, mode) || other.mode == mode));
  }

  @override
  int get hashCode => Object.hash(runtimeType, drawingState, mode);
...
abstract class _EditorState implements EditorState {
  const factory _EditorState(
      {final DrawingState drawingState,
      final EditorMode mode}) = _$EditorStateImpl;

  @override
  DrawingState get drawingState;
  @override
  EditorMode get mode;
  @override
  @JsonKey(ignore: true)
