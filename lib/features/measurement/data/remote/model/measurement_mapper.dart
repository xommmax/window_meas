...
MeasurementDTO convertFromDomain(Measurement measurement) => MeasurementDTO(
      ...
      customFieldsValues: [
        ...
        _textR(FieldToCode.quarterSize, measurement.positions.first.quarterSize),
        _enumR(FieldToCode.quarterPosition, measurement.positions.first.quarterPosition),
        _boolR(FieldToCode.staticCalculation, measurement.positions.first.staticCalculation),
        _textR(FieldToCode.profileSystem, measurement.positions.first.profileSystem),
        _enumR(FieldToCode.doorOpeningType, measurement.positions.first.doorOpeningType),
        _enumR(FieldToCode.doorstep, measurement.positions.first.doorstep),
        _enumR(FieldToCode.doorstepType, measurement.positions.first.doorstepType),
        _textR(FieldToCode.laminationInternal, measurement.positions.first.laminationInternal),
        _textR(FieldToCode.laminationExternal, measurement.positions.first.laminationExternal),
        _enumR(FieldToCode.rubberColor, measurement.positions.first.rubberColor),
        _enumR(FieldToCode.standProfile, measurement.positions.first.standProfile),
        _textR(FieldToCode.glassUnit, measurement.positions.first.glassUnit),
        _enumR(FieldToCode.panelType, measurement.positions.first.panelType),
        _enumR(FieldToCode.panelThickness, measurement.positions.first.panelThickness),
        _textR(FieldToCode.furniture, measurement.positions.first.furniture),
        _enumR(FieldToCode.windowsillType, measurement.positions.first.windowsillType),
        _enumR(FieldToCode.windowsillDepth, measurement.positions.first.windowsillDepth),
        _textR(FieldToCode.windowsillSize, measurement.positions.first.windowsillSize),
        _enumR(FieldToCode.windowsillConnector, measurement.positions.first.windowsillConnector),
        _textR(FieldToCode.windowsillColor, measurement.positions.first.windowsillColor),
        _boolR(FieldToCode.windowsillAssembly, measurement.positions.first.windowsillAssembly),
        _textR(FieldToCode.drainageDepth, measurement.positions.first.drainageDepth),
        _textR(FieldToCode.drainageWidth, measurement.positions.first.drainageWidth),
        _textR(FieldToCode.drainageColor, measurement.positions.first.drainageColor),
        _boolR(FieldToCode.drainageEndCap, measurement.positions.first.drainageEndCap),
        _textR(FieldToCode.canopyType, measurement.positions.first.canopyType),
        _textR(FieldToCode.canopySize, measurement.positions.first.canopySize),
        _textR(FieldToCode.canopyColor, measurement.positions.first.canopyColor),
        _textR(FieldToCode.slopeDepth, measurement.positions.first.slopeDepth),
        _textR(FieldToCode.slopeLength, measurement.positions.first.slopeLength),
        _textR(FieldToCode.slopeQuantity, measurement.positions.first.slopeQuantity),
        _boolR(FieldToCode.expanderRight, measurement.positions.first.expanderOption.rightEnabled),
        _enumR(
            FieldToCode.expanderRightWidth, measurement.positions.first.expanderOption.rightWidth),
        _textR(FieldToCode.expanderRightLength,
            measurement.positions.first.expanderOption.rightLength),
        _textR(FieldToCode.expanderRightQuantity,
            measurement.positions.first.expanderOption.rightAmount),
        _boolR(FieldToCode.expanderLeft, measurement.positions.first.expanderOption.leftEnabled),
        _enumR(FieldToCode.expanderLeftWidth, measurement.positions.first.expanderOption.leftWidth),
        _textR(
            FieldToCode.expanderLeftLength, measurement.positions.first.expanderOption.leftLength),
        _textR(FieldToCode.expanderLeftQuantity,
            measurement.positions.first.expanderOption.leftAmount),
        _boolR(FieldToCode.expanderTop, measurement.positions.first.expanderOption.topEnabled),
        _enumR(FieldToCode.expanderTopWidth, measurement.positions.first.expanderOption.topWidth),
        _textR(FieldToCode.expanderTopLength, measurement.positions.first.expanderOption.topLength),
        _textR(
            FieldToCode.expanderTopQuantity, measurement.positions.first.expanderOption.topAmount),
        _boolR(
            FieldToCode.expanderBottom, measurement.positions.first.expanderOption.bottomEnabled),
        _enumR(FieldToCode.expanderBottomWidth,
            measurement.positions.first.expanderOption.bottomWidth),
        _textR(FieldToCode.expanderBottomLength,
            measurement.positions.first.expanderOption.bottomLength),
        _textR(FieldToCode.expanderBottomQuantity,
            measurement.positions.first.expanderOption.bottomAmount),
...
Measurement convertToDomain(MeasurementDTO dto) => Measurement(
      ...
      positions: [
        Position(
          ...
          doorstepType:
              _enumD(FieldToCode.doorstepType, dto.customFieldsValues, DoorstepType.values),
          ...
          standProfile:
              _enumD(FieldToCode.standProfile, dto.customFieldsValues, StandProfile.values),
          ...
          expanderOption: ExpanderOption(
            ...
            rightWidth: _enumD(
                FieldToCode.expanderRightWidth, dto.customFieldsValues, ExpanderWidth.values),
            ...
            bottomWidth: _enumD(
                FieldToCode.expanderBottomWidth, dto.customFieldsValues, ExpanderWidth.values),
